...
describe('Testing the book endpoints:', () => {
  ...
  it('It should get a particular book', (done) => {
    ...
    _chai.default
      .request(_index.default)
      .get('/api/v1/books/'.concat(bookId))
      .set('Accept', 'application/json')
      .end((err, res) => {
        expect(res.status).to.equal(200);
    ...
    _chai.default
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property('message')
          .eql('Cannot find book with the id '.concat(bookId));
        done();
      });
  });
  ...
  it('It should update a book', (done) => {
    ...
    _chai.default
      .request(_index.default)
      .put('/api/v1/books/'.concat(bookId))
      .set('Accept', 'application/json')
      .send(updatedBook)
      .end((err, res) => {
        expect(res.status).to.equal(200);
  ...
  it('It should delete a book', (done) => {
    ...
    _chai.default
      .request(_index.default)
      .delete('/api/v1/books/'.concat(bookId))
      .set('Accept', 'application/json')
      .end((err, res) => {
        expect(res.status).to.equal(200);
        expect(res.body.data).to.include({});
  ...
  it('It should not delete a book with invalid id', (done) => {
    ...
    _chai.default
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property('message')
          .eql('Book with the id '.concat(bookId, ' cannot be found'));
        done();
      });
  });
